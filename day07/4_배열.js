...
-변수/상수 : 데이터 1개 저장할 수 있는 공간/메모리/상자
 ...
 console.log( 과일상자변수[3] ) //===>underfined , 없는 위치/인덱스 이기 때문
...
//7.배열에 요소/데이터 삭제
 ...
 과일상자변수.splice ( 0, 1 );   console.log( 과일상자변수 ); //'사과' 삭제 후 ['바나나','포도','체리']
 과일상자변수.splice( 1 ,0, '수박');    console.log( 과일상자변수 ); // ['바나나','포도','체리','수박']
