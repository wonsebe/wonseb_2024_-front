...
- 개발 순서
    ...
    -JS 메모리
         1. 변수: 하나의 데이터/자료 저장, 수정 가능
         2. 상수: 하나의 데이터/자료 저장, 수정 불가능
    -JS 데이터/자료
        1. 문자 2. 숫자 3.논리 4. undifined 5.배열 6.function
        -[]배열
         :여러개의 데이터를 저장할 수 있는 하나의 데이터/자료
        -function 함수
    ...
    -실습을 통해 활용
     ...
     -배열의 수: 타입/필드 수
     -단점: 필수 수가 많아질수록 배열변수가 많아지므로 관리가 힘들다.
     3. 배열2 사용
         let boardList=["제목1,내용1,1234", "제목2,내용2,4567",]
         -게시물 당 하나의 "" 처리해서 여러개 게시물(문자열) 배열에 저장
         -단점: 게시물의 정보/필드 출력시 split(분류) 분리해야 되므로 분류 순서 일치하고 관리가 어렵다.
