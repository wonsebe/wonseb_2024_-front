...
//localStorage() : Js 메모리가 아닌 브라우저(크롬) 프로그램 메모리 저장 .setItem(key, value)  / getItem(key)
//1.제품등록  2. 제품출력 3. 주문등록 4. 주문출력
//setItme: 1.(제품목록)                 3. (주문목록)
...
//6-2 : 제품목록을 브라우저(프로그램)의 localStorage 저장
//6-3 : 주문목록을 브라우저(프로그램)의 localStorage 저장
//6-4 : 주문목록을 브라우저(프로그램)의 localStorage 저장
