/*
  ...
  - 배열
    ...
    5. 배열 수정
      1. 전체 수정 : 변수명 = [ 새로운 배열 ]
      2. 특정 인덱스내 데이터 수정 : 변수명[인덱스] = 새로운 데이터

    6. 배열내 데이터 추가
      변수명.push( 데이터 )

    7. 배열내 특정 데이터 삭제
      1. 변수명.splice( 삭제할인덱스, 1 )                : 특정인덱스를 1개 삭제한다(한칸씩 당겨짐)
      2. 변수명.splice( 삽입할인덱스, 0, '새로운데이터' ) : 특정인덱스에 새로운 데이터를 삽입한다(한칸씩 밀려남)

    8. 배열내 특정 데이터의 인덱스 찾기
      변수명.indexOf( 찾을데이터 )                       : 찾을데이터가 배열내 졵재하면 위치/인덱스 반환, 없으면 -1
    
*/

// 1. 배열 만들기 = 데이터 여러개 지정하기
[ '사과', '사과', '사과' ]
...
// 5-2 배열내 특정 데이터만 수정
과일상자변수[2] = '포도'; console.log(과일상자변수)
...
과일상자변수.splice( 0, 1 ); console.log(과일상자변수)
과일상자변수.splice( 1, 0, '수박' ); console.log(과일상자변수)

// 8. 데이터의 인덱스 찾기
  // 변수명.indexof('찾을데이터') : 있으면 인덱스 호출( 0 ~) 없으면 -1
console.log( 과일상자변수.indexOf('포도'));
  // 활용
let 삭제할인덱스 = 과일상자변수.indexOf('포도')
과일상자변수.splice(삭제할인덱스, 1); console.log(과일상자변수)
